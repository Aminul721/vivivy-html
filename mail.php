...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    <body>
        <div class="container custom-container-1 container-position">
            <div class="logo">           
                <img src="https://controllistings.com/html/next-marketing/assets/images/logo-next.png" alt="Vivify">
            </div>
            <div class="table-contents">
                <h2>Vivify Contact</h2>
                <table>
                <tr>
                    <th>Name</th>
                    <td>'.$name.'</td>
                ...
                <p>&copy; 2023, Vivify, All Rights Reserved</p>
            </div>  
        </div>      
    </body>
</html>
